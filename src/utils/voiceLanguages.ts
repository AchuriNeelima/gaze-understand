...
const COMMANDS: Record<string, CommandKeywords> = {
  ...
  hi: {
    openCamera: {
      verbs: ['खोलो', 'खोल', 'चालू', 'शुरू', 'ओपन', 'स्टार्ट'],
      nouns: ['कैमरा', 'कैमेरा', 'कमरा'],
    },
    capture: {
      verbs: ['खींचो', 'खींच', 'लो', 'लें', 'ले', 'क्लिक', 'कैप्चर', 'तस्वीर'],
      nouns: ['फोटो', 'तस्वीर', 'फ़ोटो', 'चित्र', 'पिक्चर', 'इमेज'],
      solo: ['कैप्चर', 'क्लिक', 'खींचो'],
    },
  },
  te: {
    openCamera: {
      verbs: ['ఓపెన్', 'తెరువు', 'తెరు', 'ప్రారంభించు', 'స్టార్ట్', 'చేయి', 'చెయ్', 'చెయ్యి', 'చేయండి'],
      nouns: ['కెమెరా', 'కేమెరా', 'కామెరా', 'కెమరా', 'camera'],
    },
    capture: {
      verbs: ['తీయి', 'తీయండి', 'తీసుకో', 'క్లిక్', 'క్యాప్చర్', 'తీయు', 'తియ్యి'],
      nouns: ['ఫోటో', 'చిత్రం', 'పిక్చర్', 'బొమ్మ', 'ఇమేజ్', 'photo'],
      solo: ['క్యాప్చర్', 'క్లిక్', 'తీయి', 'తీయు', 'capture'],
    },
  },
};
